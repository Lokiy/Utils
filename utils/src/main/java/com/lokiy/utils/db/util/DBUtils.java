 ...
 */
package com.lokiy.utils.db.util;
...
import com.lokiy.utils.ReflectUtils;
import com.lokiy.utils.XLog;
import com.lokiy.utils.db.DBHelper;
import com.lokiy.utils.db.DBSelection;
import com.lokiy.utils.db.Table;
import com.lokiy.utils.db.TableInfo;
import com.lokiy.utils.db.annotation.Encrypt;
import com.lokiy.utils.db.annotation.Expose;
import com.lokiy.utils.db.annotation.NotNull;
import com.lokiy.utils.db.annotation.OrderBy;
import com.lokiy.utils.db.annotation.Rename;
import com.lokiy.utils.db.annotation.TableVersion;
import com.lokiy.utils.db.annotation.Unique;
	...
	public <T extends Serializable> DBSelection<T> getSelection(T bean) {
		...
		if (orderByList.size() > 0) {
			...
			for (Field field : fieldArray) {
				...
				orderBy.append("`");
				orderBy.append(field.getAnnotation(OrderBy.class).value() == OrderBy.SortAs.ASC ? " ASC" : " DESC");
				orderBy.append(",");
			}
		}
		if (orderBy.length() > 1) {
